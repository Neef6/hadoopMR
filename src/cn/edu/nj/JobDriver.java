...
public class JobDriver {
  public static void initJob(JobModel[] jobs) throws IOException, ClassNotFoundException, InterruptedException {
    //init jobs
    for (JobModel jobModel : jobs) {
      ...
      FileInputFormat.addInputPath(job, jobModel.getInputPaths());
